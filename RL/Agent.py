...
class PPOMemory:
    def __init__(self, batch_size, step_to_train):
        ...
        self.step_to_train = step_to_train
...
class Agent:
    def __init__(self, gamma=0.95, batch_size=64, n_epochs=10, step_to_train=40, device='cpu'):
        self.gamma = gamma
        ...
        self.memory = PPOMemory(batch_size, step_to_train)
